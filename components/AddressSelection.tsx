  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm border border-gray-200  ">
      ...
      <Dialog open={isOpen} onClose={handleClose} className="relative z-50">
        ...
        {/* Dialog panel */}
        <div className="fixed inset-0 flex items-center justify-center p-6 pt-5">
          <Dialog.Panel className="bg-white rounded-xl shadow-lg max-w-sm w-full p-4 max-h-full overflow-y-scroll">
            {/* Header */}
